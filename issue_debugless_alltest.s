...
.L10:
	...
	l.lwz   	r5,-104(r2)	 # SI load
#APP
# 154 "issue_debugless.c" 1
	l.lwz r14,0(r3)
	l.cust5 r4,r14,r5,1,1
...
.L11:
	...
	l.lwz   	r5,-104(r2)	 # SI load
#APP
# 163 "issue_debugless.c" 1
	l.lwz r14,0(r3)
	l.cust5 r4,r14,r5,2,1
...
.L12:
	...
	l.lwz   	r5,-104(r2)	 # SI load
#APP
# 172 "issue_debugless.c" 1
	l.lwz r14,0(r3)
	l.cust5 r4,r14,r5,3,1
...
.L13:
	...
	l.lwz   	r4,-100(r2)	 # SI load
	l.lwz   	r5,-104(r2)	 # SI load
	l.lwz   	r6,-92(r2)	 # SI load
#APP
# 181 "issue_debugless.c" 1
	l.lwz r14,0(r3)
	l.cust5 r4,r14,r5,0,2
	l.cust5 r4,r6,r5,0,1
...
# 198 "issue_debugless.c" 1
	...
	l.nop 
	l.nop 
	l.cust5 r12,r4,r4, 15,8
	l.cust5 r13,r4,r4, 14,8
	l.cust5 r15,r4,r4, 13,8
	l.cust5 r17,r4,r4, 12,8
	l.cust5 r6,r4,r4, 11,8
	l.cust5 r7,r4,r4, 10,8
	l.cust5 r8,r4,r4, 9,8
